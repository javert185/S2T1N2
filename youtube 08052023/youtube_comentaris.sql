...
CREATE TABLE `comentaris` (
  ...
  `text_comentari` varchar(40) DEFAULT NULL,
  ...
  CONSTRAINT `comentaris_ibfk_1` FOREIGN KEY (`video_id`) REFERENCES `video` (`video_id`) ON DELETE CASCADE,
  CONSTRAINT `comentaris_ibfk_2` FOREIGN KEY (`usuari_id`) REFERENCES `usuari` (`usuari_id`) ON DELETE CASCADE
...
-- Dump completed on 2023-05-08 16:51:17
